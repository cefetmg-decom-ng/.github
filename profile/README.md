...
<a name="top"></a>
  ...
  - [📚 Regras gerais para alunos](#-regras-gerais-para-alunos)
    ...
    - [🏷️ 2. Nomenclatura de times e repositórios](#-2-nomenclatura-de-times-e-repositórios)
  ...
  - **🎓 Ensino Técnico**: Informática e Redes de Computadores
  - **🎓 Ensino Superior (Graduação)**: Engenharia de Computação
  ...
  ### 🏷️ 2. Nomenclatura de times e repositórios
  ...
  - 🗂️ `artefatos/`: pasta dedicada a códigos-fonte, scripts de banco de dados e arquivos de configuração. Incluir instruções de compilação/execução.
  ...
  - ⚖️ `LICENSE`: arquivo de licença (sugerimos MIT para código).
